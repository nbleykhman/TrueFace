...
NUM_IMAGES         = 4
CALLS_PER_MINUTE   = 5
SLEEP_BETWEEN      = 60.0 / CALLS_PER_MINUTE  # seconds
...
while successes < NUM_IMAGES:
    ...
    # Retry loop for rate limits & server errors
    ...
    if not data:
        ...
        time.sleep(SLEEP_BETWEEN)
        continue  # do NOT increment counter or successes
